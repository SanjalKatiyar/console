...
export const CreateStorageClass: React.FC<CreateStorageClassProps> = ({ state, dispatch, ns }) => {
  ...
  const lvsNameSelectorTxt = t(
    'ceph-storage-plugin~A Local Volume Set allows you to filter a set of disks, group them and create a dedicated storage class to consume storage from them.',
  );
